...
package com.rnveach.tools.checkstyle.extras.events;

import com.puppycrawl.tools.checkstyle.api.FileContents;
import com.puppycrawl.tools.checkstyle.api.Violation;
import com.rnveach.tools.checkstyle.extras.asts.PropertyAST;

/** Raw {@code PropertyWalker} event for audit. */
public final class PropertyWalkerAuditEvent {
    ...
    /** Root ast element. **/
    private final PropertyAST rootAst;

    /**
     * Creates a new {@code PropertyWalkerAuditEvent} instance.
     *
     ...
     */
    public PropertyWalkerAuditEvent(FileContents fileContents, String fileName, Violation violation,
            PropertyAST rootAst) {
     ...
     *
     * @return the file name currently being audited or null if there is no
     *         relation to a file.
     */
    ...
    /**
     * Return the line number on the source file where the event occurred. This
     * may be 0 if there is no relation to a file content.
     *

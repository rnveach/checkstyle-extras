...
/** Raw {@code XmlWalker} event for audit. */
public final class XmlWalkerAuditEvent {
    ...
    /** Root ast element. **/
    private final XmlAST rootAst;

    /**
     * Creates a new {@code XmlWalkerAuditEvent} instance.
     *
     ...
     */
    public XmlWalkerAuditEvent(FileContents fileContents, String fileName, Violation violation,
            XmlAST rootAst) {

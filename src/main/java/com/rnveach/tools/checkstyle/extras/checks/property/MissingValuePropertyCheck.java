...
/** Checks for a missing value for a property. */
public final class MissingValuePropertyCheck extends AbstractPropertyCheck {

    /**
     * A key is pointing to the warning message text in "messages.properties"
     * file.
     */
    public static final String MSG_KEY = "missing.value";
    ...
    public void visitToken(PropertyAST ast) {
        if (ast.findFirst(PropertyTokenTypes.VALUE) == null) {
            log(ast, MSG_KEY);
        }
    }

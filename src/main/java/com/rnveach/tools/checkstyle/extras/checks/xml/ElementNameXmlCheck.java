...
/** Checks that element names conform to a specified pattern. */
public final class ElementNameXmlCheck extends AbstractXmlCheck {
    ...
    public void visitToken(XmlAST ast) {
        if (ast.getParent().getType() == XmlTokenTypes.START_ELEMENT) {

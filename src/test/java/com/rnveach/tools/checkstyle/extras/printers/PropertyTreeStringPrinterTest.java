...
public class PropertyTreeStringPrinterTest extends AbstractTreeTestSupport {
    ...
    @Test
    public void testKeysAlone() throws Exception {
        verifyPropertyAst(getPath("ExpectedKeysAloneProperty.txt"),
                getPath("InputKeysAlone.properties"));
    }

    @Test
    public void testIndentation() throws Exception {
        verifyPropertyAst(getPath("ExpectedIndentationProperty.txt"),
                getPath("InputIndentation.properties"));
    }

...
public class IllegalTokenTextPropertyCheckTest extends AbstractExtraModuleTestSupport {
    ...
    public void testDefault() throws Exception {
        ...
        verify(config, getPath("IllegalTokenTextProperty.properties"),
    ...
    public void testViolation() throws Exception {
        ...
        final String[] expected = {
                "3:5: " + getCheckMessage(MSG_KEY, "ASSIGNMENT"),
                "4:5: " + getCheckMessage(MSG_KEY, "ASSIGNMENT"),
        };

        verify(config, getPath("IllegalTokenTextProperty.properties"), expected);
    }

    @Test
    public void testCommentViolation() throws Exception {
        final DefaultConfiguration config = createModuleConfig(IllegalTokenPropertyCheck.class);
        config.addProperty("tokens", "COMMENT_BLOCK");
